...
exports.INFORMATION_SUBTYPE = void 0;
const Card_1 = __importStar(require("./Card"));
exports.INFORMATION_SUBTYPE = {
    ACTUALLY_USEFUL: "Actually Useful",
    COSMOLOGY: "Cosmology",
};
const informationSubtypes = Object.values(exports.INFORMATION_SUBTYPE);
class Information extends Card_1.default {
    constructor(id, name, owner, bodyText, faction, rarity, subtype) {
        ...
        this.type = Card_1.CARD_TYPE.INFORMATION;
