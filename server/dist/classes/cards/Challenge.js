...
exports.CHALLENGE_SUBTYPE = void 0;
const Card_1 = __importStar(require("./Card"));
exports.CHALLENGE_SUBTYPE = {
    TUTORIAL_MISSION: "Tutorial Mission",
};
const challengeSubtypes = Object.values(exports.CHALLENGE_SUBTYPE);
class Challenge extends Card_1.default {
    constructor(id, name, owner, bodyText, faction, rarity, subtype) {
        ...
        this.type = Card_1.CARD_TYPE.CHALLENGE;
