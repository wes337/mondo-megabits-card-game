...
exports.LOCATION_SUBTYPE = void 0;
const Card_1 = __importStar(require("./Card"));
exports.LOCATION_SUBTYPE = {
    REAL_ESTATE: "Real Estate",
    REALM: "Realm",
    ZONE: "Zone",
};
const locationSubtypes = Object.values(exports.LOCATION_SUBTYPE);
class Location extends Card_1.default {
    constructor(id, name, owner, bodyText, faction, rarity, subtype) {
        ...
        this.type = Card_1.CARD_TYPE.LOCATION;
