...
exports.allCards = exports.createRandomDeck = exports.getRandomCards = exports.getCardImageById = exports.getCardImage = void 0;
...
const getCardImageById = (cardId) => {
    const card = exports.allCards.find((card) => card.id.toString() === cardId.toString());
    return (0, exports.getCardImage)(card);
};
exports.getCardImageById = getCardImageById;
const getRandomCards = (amount) => {
    const shuffledCards = [...exports.allCards].sort(() => {
